...
\begin{tikzpicture}[
    ...
    % Bridge: 87.0
    \node[bar=green!70, minimum height=4.35cm, anchor=south] at (7.0, 0) {};
    \node[font=\scriptsize, rotate=45, anchor=west] at (6.6, -0.2) {Bridge};
    \node[font=\scriptsize, font=\bfseries] at (7.0, 4.55) {87.0};

    % Baseline reference line (Without DANEEL: 53.73)
    \draw[dashed, gray] (0.5, 2.69) -- (7.5, 2.69);
    \node[font=\scriptsize, gray, anchor=west] at (7.6, 2.69) {Baseline: 53.7};
